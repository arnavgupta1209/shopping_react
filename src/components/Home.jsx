  ...
  return (<>
    ...
    <div className=" flex min-w-full grow">
      <div className=" flex grow flex-col w-1/2">
        <div className="bg-red-600 grow-[2] text-white text-8xl text-nowrap overflow-visible relative"><span className="absolute bg-red-500 bottom-0 p-3">Shop Whenever, Wherever</span></div>
